...
import gr.atc.t4m.security.JwtAttributesValidatorFilter;
...
import gr.atc.t4m.security.JwtAuthConverter;
import gr.atc.t4m.security.RateLimitingFilter;
import gr.atc.t4m.security.UnauthorizedEntryPoint;
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http, UnauthorizedEntryPoint entryPoint)
        ...
        http.sessionManagement(session -> session.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers("/api/notification-service/**").permitAll()
                        // Actuator
